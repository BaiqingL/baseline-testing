...
func (c *listenerClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, "/addRequest.Listener/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedListenerServer) Add(context.Context, *AddRequest) (*AddResponse, error) {
...
func _Listener_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ListenerServer).Add(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/addRequest.Listener/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListenerServer).Add(ctx, req.(*AddRequest))
	}
...
var Listener_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "addRequest.Listener",
	HandlerType: (*ListenerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Add",
			Handler:    _Listener_Add_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "addRequest.proto",
}
